...
class TextRecognizer(BaseOCRV20):
    def __init__(self):
        ...
        self.max_text_length = 10
        postprocess_params = {
            'name': 'CTCLabelDecode',
            "character_type": 'ch',
            "character_dict_path": os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))),
        ...
        self.weights_path = 'C:\\Users\\kiko\\Desktop\\paddleocr_torch\\PaddleOCR2Pytorch-main\\ch_ptocr_mobile_v2.0_rec_infer.pth'
        self.yaml_path = None
...
def main(_):
    image_file_list = get_image_file_list('C:\\Users\\kiko\\Desktop\\paddleocr_torch\\PaddleOCR2Pytorch-main\\num_data\\0_1.jpg')
