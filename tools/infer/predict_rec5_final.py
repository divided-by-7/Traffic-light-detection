...
class TextRecognizer(BaseOCRV20):
    def __init__(self):
        ...
        self.weights_path = 'D:\\traffic_light_detect_1\\ch_ptocr_v2_rec_infer.pth'
        self.yaml_path = None
...
def ocr(crop):
    image_file_list = get_image_file_list('D:\\traffic_light_detect\\cut\\cut.jpg')
    ...
    for image_file in image_file_list:
        ...
        # img = cv2.imread(image_file)        # print('img.type',type(img)) # numpy array
